# Nopolabs\EBay\Sell\Inventory\InventoryItemGroupApi
...
> \Nopolabs\EBay\Sell\Inventory\Model\BaseResponse createOrReplaceInventoryItemGroup($inventory_item_group_key, $content_language, $body)
...
$apiInstance = new Nopolabs\EBay\Sell\Inventory\Api\InventoryItemGroupApi(
...
$body = new \Nopolabs\EBay\Sell\Inventory\Model\InventoryItemGroup(); // \Nopolabs\EBay\Sell\Inventory\Model\InventoryItemGroup | Details of the inventory Item Group
 ...
 **body** | [**\Nopolabs\EBay\Sell\Inventory\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)| Details of the inventory Item Group |
...
> \Nopolabs\EBay\Sell\Inventory\Model\InventoryItemGroup getInventoryItemGroup($inventory_item_group_key)
...
[**\Nopolabs\EBay\Sell\Inventory\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)
