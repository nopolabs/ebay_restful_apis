...
class InventoryLocationFull implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'location' => '\Nopolabs\EBay\Sell\Inventory\Model\LocationDetails',
     ...
     * Gets location
     *
     * @return \Nopolabs\EBay\Sell\Inventory\Model\LocationDetails
     */
     ...
     * Sets location
     *
     * @param \Nopolabs\EBay\Sell\Inventory\Model\LocationDetails $location location
     *
     * @return $this
     */
     ...
     *
     * @param \Nopolabs\EBay\Sell\Inventory\Model\OperatingHours[] $operating_hours Although not technically required, this container is highly recommended to be used to specify operating hours for a store inventory location. This container is used to express the regular operating hours for a store location during each day of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container will be needed for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Sets special_hours
     *
     * @param \Nopolabs\EBay\Sell\Inventory\Model\SpecialHours[] $special_hours This container is used to express the special operating hours for a store inventory location on a specific date, such as a holiday. The special hours specified for the specific date will override the normal operating hours for that particular day of the week.
     *
     * @return $this
     */
