...
class BulkInventoryItemResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'responses' => '\Nopolabs\EBay\Sell\Inventory\Model\InventoryItemResponse[]'
    ];
     ...
     * Gets responses
     *
     * @return \Nopolabs\EBay\Sell\Inventory\Model\InventoryItemResponse[]
     */
     ...
     * Sets responses
     *
     * @param \Nopolabs\EBay\Sell\Inventory\Model\InventoryItemResponse[] $responses This is the base container of the <strong>bulkCreateOrReplaceInventoryItem</strong> response. The results of each attempted inventory item creation/update is captured under this container.
     *
     * @return $this
     */
