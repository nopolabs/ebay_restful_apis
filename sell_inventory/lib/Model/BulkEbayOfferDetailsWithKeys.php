...
class BulkEbayOfferDetailsWithKeys implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'requests' => '\Nopolabs\EBay\Sell\Inventory\Model\EbayOfferDetailsWithKeys[]'
    ];
     ...
     * Gets requests
     *
     * @return \Nopolabs\EBay\Sell\Inventory\Model\EbayOfferDetailsWithKeys[]
     */
     ...
     * Sets requests
     *
     * @param \Nopolabs\EBay\Sell\Inventory\Model\EbayOfferDetailsWithKeys[] $requests The details of each offer that is being created is passed in under this container. Up to 25 offers can be created with one <strong>bulkCreateOffer</strong> call.
     *
     * @return $this
     */
