...
class BulkGetInventoryItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'requests' => '\Nopolabs\EBay\Sell\Inventory\Model\GetInventoryItem[]'
    ];
     ...
     * Gets requests
     *
     * @return \Nopolabs\EBay\Sell\Inventory\Model\GetInventoryItem[]
     */
     ...
     * Sets requests
     *
     * @param \Nopolabs\EBay\Sell\Inventory\Model\GetInventoryItem[] $requests The seller passes in multiple SKU values under this container to retrieve multiple inventory item records. Up to 25 inventory item records can be retrieved at one time.
     *
     * @return $this
     */
