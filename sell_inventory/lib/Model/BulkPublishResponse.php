...
class BulkPublishResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'responses' => '\Nopolabs\EBay\Sell\Inventory\Model\OfferResponseWithListingId[]'
    ];
     ...
     * Gets responses
     *
     * @return \Nopolabs\EBay\Sell\Inventory\Model\OfferResponseWithListingId[]
     */
     ...
     * Sets responses
     *
     * @param \Nopolabs\EBay\Sell\Inventory\Model\OfferResponseWithListingId[] $responses A node is returned under the <strong>responses</strong> container to indicate the success or failure of each offer that the seller was attempting to publish.
     *
     * @return $this
     */
