...
class PrivilegeApi
{
     ...
     * @return \Nopolabs\EBay\Sell\Account\Model\SellingPrivileges
     */
     ...
     * @throws \Nopolabs\EBay\Sell\Account\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Nopolabs\EBay\Sell\Account\Model\SellingPrivileges, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrivilegesWithHttpInfo()
    {
        $returnType = '\Nopolabs\EBay\Sell\Account\Model\SellingPrivileges';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Nopolabs\EBay\Sell\Account\Model\SellingPrivileges',
