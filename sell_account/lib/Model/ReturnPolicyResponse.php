...
class ReturnPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'return_policies' => '\Nopolabs\EBay\Sell\Account\Model\ReturnPolicy[]',
        'total' => 'int'
    ];
     ...
     *
     * @param \Nopolabs\EBay\Sell\Account\Model\ReturnPolicy[] $return_policies A list of the seller's return policies.
     *
     * @return $this
     */
