...
class FulfillmentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fulfillment_policies' => '\Nopolabs\EBay\Sell\Account\Model\FulfillmentPolicy[]',
        'href' => 'string',
        'limit' => 'int',
        'next' => 'string',
        'offset' => 'int',
     ...
     *
     * @param \Nopolabs\EBay\Sell\Account\Model\FulfillmentPolicy[] $fulfillment_policies A list of the seller's fulfillment policies.
     *
     * @return $this
     */
