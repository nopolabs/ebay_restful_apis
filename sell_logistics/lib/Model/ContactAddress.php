...
class ContactAddress implements ModelInterface, ArrayAccess
{
     ...
     * Sets address_line2
     *
     * @param string $address_line2 The second line of the street address. Use this field for additional address information, such as a suite or apartment number.
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param string $country_code The country of the address, represented as two-letter ISO 3166-1 Alpha-2 country code. For example, US represents the United States and DE represents Germany. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/CountryCodeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets county
     *
     * @param string $county The county (not country) in which the address is located. Counties typically contain multiple cities or towns.
     *
     * @return $this
     */
     ...
     *
     * @param string $state_or_province The state or province in which the address is located. States and provinces often contain multiple counties.
     *
     * @return $this
     */
