...
class Weight implements ModelInterface, ArrayAccess
{
     ...
     * Sets unit
     *
     * @param string $unit The unit of measure used to express the weight of the package. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/logistics/types/WeightUnitOfMeasureEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The numeric value of the weight of the package, as measured by the value of unit.
     *
     * @return $this
     */
