 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentCancellation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipmentCancellation';
     ...
     *
     * @param string $cancellation_requested_date The time and date the request was made to cancel the shipment, formatted as an ISO 8601 UTC string.
     *
     * @return $this
     */
