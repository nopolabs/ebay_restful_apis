...
class BulkDeleteAdRequest implements ModelInterface, ArrayAccess
{
     ...
     * Gets requests
     *
     * @return \Nopolabs\EBay\Sell\Marketing\Model\DeleteAdRequest[]
     */
     ...
     * Sets requests
     *
     * @param \Nopolabs\EBay\Sell\Marketing\Model\DeleteAdRequest[] $requests An array of the listing IDs that identify the ads to remove. Note: This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return $this
     */
