...
class ItemPromotionResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets discount_rules
     *
     * @param \Nopolabs\EBay\Sell\Marketing\Model\DiscountRule[] $discount_rules A list containing the promotion benefits (discountRule) and the rules that define when the benefit is applied (discountSpecification).
     *
     * @return $this
     */
