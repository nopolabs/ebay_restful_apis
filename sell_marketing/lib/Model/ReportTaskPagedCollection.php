...
class ReportTaskPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'report_tasks' => '\Nopolabs\EBay\Sell\Marketing\Model\ReportTask[]',
        'total' => 'int'
    ];
     ...
     * Sets report_tasks
     *
     * @param \Nopolabs\EBay\Sell\Marketing\Model\ReportTask[] $report_tasks A list of report tasks contained on this page from the paginated response.
     *
     * @return $this
     */
