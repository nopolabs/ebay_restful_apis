...
class AdPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'ads' => '\Nopolabs\EBay\Sell\Marketing\Model\Ad[]',
        'href' => 'string',
        'limit' => 'int',
        'next' => 'string',
        'offset' => 'int',
     ...
     * Sets ads
     *
     * @param \Nopolabs\EBay\Sell\Marketing\Model\Ad[] $ads A list of ads contained on this page from the paginated response.
     *
     * @return $this
     */
