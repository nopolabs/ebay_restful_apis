...
class BulkCreateAdsByInventoryReferenceRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'requests' => '\Nopolabs\EBay\Sell\Marketing\Model\CreateAdsByInventoryReferenceRequest[]'
    ];
     ...
     * Gets requests
     *
     * @return \Nopolabs\EBay\Sell\Marketing\Model\CreateAdsByInventoryReferenceRequest[]
     */
     ...
     * Sets requests
     *
     * @param \Nopolabs\EBay\Sell\Marketing\Model\CreateAdsByInventoryReferenceRequest[] $requests A lsit of inventory reference ID and inventory reference type pairs, and the bid percentage, which the call uses to create ads in bulk.
     *
     * @return $this
     */
