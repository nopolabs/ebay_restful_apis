...
class TimeDuration implements ModelInterface, ArrayAccess
{
     ...
     * Sets value
     *
     * @param int $value An amount of time, as measured by the time-measurement units specified in the unit field.
     *
     * @return $this
     */
