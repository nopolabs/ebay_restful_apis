...
/**
 * ProductAspect Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductAspect implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductAspect';
     ...
     * Sets values
     *
     * @param string[] $values Required or returned if a value is provided for the name field. This is a list of one or more localized values of this product aspect.
     *
     * @return $this
     */
