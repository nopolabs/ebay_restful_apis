...
class AspectValueDistribution implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $localized_aspect_value The localized value of the category aspect identified by refinement.aspectDistributions.localizedAspectName.
     *
     * @return $this
     */
     ...
     *
     * @param string $refinement_href A HATEOAS reference that further refines the search with this particular localizedAspectValue.
     *
     * @return $this
     */
