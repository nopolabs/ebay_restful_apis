...
/**
 * CategoryAspectValue Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CategoryAspectValue implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CategoryAspectValue';
     ...
     * Sets value
     *
     * @param string $value A supported value of the corresponding category aspect (shown in the aspects.name field). Every supported value for the category aspect is shown in the aspects.values container.
     *
     * @return $this
     */
